            ...
            },
            {
                ...
                items: [
                    ...
                    { text: 'Release Notes',  collapsed: true,
                        items: [
                            { text: 'Current Releases', link: '/releases' },
                            { text: 'Archived Releases', link: '/releases-archived',
                                collapsed: true,
                                items: [
                                    { text: '2024', link: '/releases-2024' },
                                    { text: '2023', link: '/releases-2023',  },
                                    { text: '2022', link: '/releases-2022' },
                                    { text: '2021', link: '/releases-2021',  },
                            ] },
                        ]
                    },
